...
Module 1 is the groundwork under everything else. It's one part of a full roadmap:

**Foundations → Offensive Security → Defensive Security → Cloud → Career**

I'm learning both the red and blue sides to intermediate level, then choosing my
specialization from a position of real understanding — not guesswork. Each module ends
with a portfolio project, so the learning is always something I can show.

- ✅ **Module 1 — Foundations** *(this repo, complete)*
- 🔜 **Module 2** — *coming soon, in its own repository*

If any of this is useful to you as you learn too, feel free to explore, and a ⭐ is always appreciated.

---

## 📄 License

Released under the [MIT License](LICENSE) — free to learn from and build on.

<div align="center">

Built by **Faiza Mobeen** · [github.com/Faizambn](https://github.com/Faizambn)

🚧 *This module is complete; the journey continues in Module 2.*
